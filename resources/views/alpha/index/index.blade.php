	...
	<div class="col-lg-4">
		...
		<div class="panel-body">
			<a href="#" class="task-thumb">
				<img src="{{ URL::asset('/') }}img/avatar1.jpg" alt="">
			</a>
				...
				<div class="timeline-desk">
					<div class="panel">
						<div class="panel-body">
							...
							<div class="album">
								<a href="#">
									<img alt="" src="{{ URL::asset('/') }}img/sm-img-1.jpg">
								</a>
								<a href="#">
									<img alt="" src="{{ URL::asset('/') }}img/sm-img-2.jpg">
								</a>
								<a href="#">
									<img alt="" src="{{ URL::asset('/') }}img/sm-img-3.jpg">
								</a>
								<a href="#">
									<img alt="" src="{{ URL::asset('/') }}img/sm-img-1.jpg">
								</a>
...
<div class="row">
	<div class="col-lg-8">
		...
		<div class="panel-body text-center">
			<div class="pro-thumb">
				<img src="{{ URL::asset('/') }}img/ring.jpg" alt="">
			</div>
		</div>
		</aside>
		</section>
				...
				<div class="follower">
					<div class="panel-body">
						...
						<div class="follow-ava">
							<img src="{{ URL::asset('/') }}img/follower-avatar.jpg" alt="">
						</div>
					</div>
				</div>
